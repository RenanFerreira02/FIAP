...
public class Controle {
            ...
            try {
                ...
                switch (opcao) {
                    ...
                    case 4:
                        return;
                    default:
                        showMessageDialog(null, "A opção está inválida!");
    ...
    public void reservar() {
        ...
        String identificador = showInputDialog("Qual o CPF ou CNPJ para reserva?");
        ...
        for (Cliente cliente : listaCliente) {
            if (cliente.getIdentificador().equals(identificador)) {
                ...
                valorOriginal = random.nextDouble(100, 500);

                assento = listaAssento.get(numeroAssento - 1);
        ...
        showMessageDialog(null, "CPF/CNPJ: " + identificador + " não localizado!");
    }


    public void pesquisar() {
        String identificador = showInputDialog("Qual o CPF ou CNPJ para consulta?");

        for (Reserva reserva : listaReserva) {
            if (reserva.getCliente().getIdentificador().equals(identificador)) {
                showMessageDialog(null, "Reserva encontrada: " + reserva);

                return;
            }
        }
        showMessageDialog(null, "CPF/CNPJ: " + identificador + " sem reserva!");
    }
